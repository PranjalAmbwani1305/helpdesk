...
def query_vectors(query, selected_pdf):
    try:
        ...
        if results["matches"]:
            ...
            # Collect both titles and contents from the results
            for match in results["matches"]:
                if match["metadata"]["type"] == "title":
                    matched_titles.append(match["metadata"]["text"])
                elif match["metadata"]["type"] == "content":
                    matched_contents.append(match["metadata"]["text"])
            
            # Combine titles and contents for display
